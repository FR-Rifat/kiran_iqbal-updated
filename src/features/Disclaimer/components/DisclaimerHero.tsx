...
const DisclaimerHero = () => (
  <section className="bg-[#e6f5e6] px-5 py-20 text-center sm:py-28">
    ...
    <h1 className="mx-auto mt-4 max-w-5xl font-['Barlow_Condensed'] text-5xl font-extrabold uppercase leading-[0.95] tracking-tight text-gray-900 sm:text-6xl lg:text-7xl">
      A&amp;R Auto Parts <span className="text-green-600">Disclaimer</span>
    </h1>
    <p className="mx-auto mt-5 max-w-3xl text-sm leading-6 text-slate-600 sm:text-base">
      Important information about our website, used automotive parts, product
      information, vehicle compatibility, pricing, shipping, warranties, and
      services.
    </p>
