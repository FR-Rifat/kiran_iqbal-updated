...
const WarrantyBanner = () => {
  return (
    <section className="relative w-full overflow-hidden ">
      ...
      <div className="relative mx-auto flex w-full max-w-[1160px] flex-col md:flex-row items-center justify-between gap-6 px-5 py-10">
        <div className="flex flex-col sm:flex-row items-center gap-6 text-center sm:text-left">
          ...
          <div className="relative flex size-[110px] shrink-0 flex-col items-center justify-center rounded-full bg-white p-2 shadow-[0_0_0_8px_rgba(255,255,255,0.2)]">
            <span className="text-[43px] font-extrabold text-green-600 font-['Barlow_Condensed']">
              3
            </span>
            <span className="text-[13px] font-bold uppercase text-green-600 font-['Barlow_Condensed'] mt-0.5 text-center">
              Year Warranty
            </span>
          </div>
